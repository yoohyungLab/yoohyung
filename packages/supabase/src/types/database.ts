...
export type Database = {
	...
	public: {
		...
		Functions: {
			...
			admin_verify_session: { Args: { p_token: string }; Returns: Json };
			algorithm_sign: {
			...
			delete_test: { Args: { test_uuid: string }; Returns: Json };
			get_current_week_balance_game: { Args: never; Returns: Json };
			...
			increment_balance_game_vote: {
				...
				Returns: {
					return_id: string;
					return_total_votes: number;
					return_votes_a: number;
					return_votes_b: number;
				}[];
			};
			...
			increment_test_start: { Args: { test_uuid: string }; Returns: undefined };
			sign: {
