			...
			<AdminCard className="p-6">
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-2xl font-bold text-gray-900">{basicStats?.responses?.toLocaleString() || 0}</p>
			...
			<AdminCard className="p-6">
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-2xl font-bold text-gray-900">{basicStats?.completions?.toLocaleString() || 0}</p>
