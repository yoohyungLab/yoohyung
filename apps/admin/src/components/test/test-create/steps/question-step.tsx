...
import { Card, CardContent, CardHeader, CardTitle, DefaultInput, DefaultTextarea, Label, Switch, IconButton } from '@repo/ui';
import { Plus, Trash2 } from 'lucide-react';
import { ImageUpload } from '../components';
import type { QuestionCreationData, ChoiceCreationData } from '../../../api/test-creation.service';
                                        ...
                                        <div key={choiceIndex} className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <DefaultInput
                                                    ...
                                                    onChange={(e) =>
                                                        onUpdateChoice(questionIndex, choiceIndex, { choice_text: e.target.value })
                                                    }
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Switch
                                                        ...
                                                        onCheckedChange={(checked) =>
                                                            onUpdateChoice(questionIndex, choiceIndex, { is_correct: checked })
                                                        }
                                                    />
                                                </div>
                                            ) : (
