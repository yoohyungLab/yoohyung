...
import { ResultDetails } from '@/features/test-results/ui/result-details';
import { ResultComparisonSection } from '@/features/test-results/ui/result-comparison-section';
import { ResultCtaSection } from '@/features/test-results/ui/result-cta-section';
import { ShareModal } from '@/features/test-results/ui/share-modal';
...
export function ResultPage() {
    ...
    const handleSave = () => {
        if (isLoggedIn) {
            ...
            navigate('/auth/signup?redirect=/tests/result');
        }
