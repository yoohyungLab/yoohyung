    ...
    return (
        <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">유형별 TOP 테스트</h2>
                ...
                {tests.map((test) => (
                    ...
                    >
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-purple-400 to-pink-400 rounded-lg flex items-center justify-center text-white text-xl font-bold">
                                {test.title.charAt(0)}
                            </div>
