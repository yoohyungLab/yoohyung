...
import { TestContainer } from '@/features/test/ui/psychology/test-container';
import { BalanceGameContainer } from '@/features/test/ui/balance-game/balance-game-container';
...
export function TestPage({ test, categories }: ITestPageProps) {
