...
export const EGEN_TETO_QUESTIONS: Question[] = [
    {
        ...
        options: [
            { text: '어머 무슨 일이야? 😰 진짜 힘들었겠다... 괜찮아?', score: 2, type: '에겐 강' },
            { text: '헉 뭔 일? 이야기해줘 나도 같이 속상해할게 ㅠ', score: 1, type: '에겐 약' },
    ...
    },
    {
        ...
        options: [
            { text: '다들 어디가 좋을까요~? 의견 들어보고 싶어요!', score: 2, type: '에겐 강' },
    ...
    },
    {
        ...
        text: '넷플릭스 뭐 볼지 고를 때?',
        options: [
            { text: '같이 보고 싶은 거 있어? 취향 맞춰볼까?', score: 2, type: '에겐 강' },
            { text: '로맨스나 힐링 드라마 어때? 무거운 건 별로...', score: 1, type: '에겐 약' },
            { text: '평점 높은 거 추천해줄까? 장르별로 정리해뒀어', score: -1, type: '테토 약' },
    ...
    },
    {
        ...
        options: [
            ...
            { text: '상대반응 살피며 조심스럽게 대화 시도', score: 1, type: '에겐 약' },
            { text: '어디 살아요? 뭐 하세요? 적당한 질문으로 분위기 풀기', score: -1, type: '테토 약' },
    ...
    },
    {
        ...
        text: '데이트 코스 정할 때?',
        options: [
            { text: '너 가고 싶은 데 있어? 네가 좋아할 만한 곳 찾아볼게!', score: 2, type: '에겐 강' },
            { text: '카페나 공원에서 산책하면서 이야기하자', score: 1, type: '에겐 약' },
            { text: '날씨 보고 실내/실외 나눠서 정하자. 맛집 반영', score: -1, type: '테토 약' },
            { text: '내가 아는 좋은 데 있어. 거기로 가자', score: -2, type: '테토 강' },
        ],
    },
    {
        id: 7,
        ...
        options: [
            { text: '우리 다시 한번 차근차근 얘기해볼까요?', score: 2, type: '에겐 강' },
    ...
    },
    {
        ...
        options: [
            ...
            { text: '혼자 조용히 드라마 보거나 음악 듣기', score: 1, type: '에겐 약' },
            { text: '운동이나 취미에 몰입', score: -1, type: '테토 약' },
            { text: '스트레스가 뭔 스트레스야. 그냥 잊어버려', score: -2, type: '테토 강' },
        ],
    },
    {
        id: 10,
        text: '새로운 도전 앞에서?',
        options: [
            { text: '주변 사람들이 어떻게 생각할까? 타인 반응 우선', score: 2, type: '에겐 강' },
            { text: '실패하면 어떡하지… 불안하지만 천천히 준비', score: 1, type: '에겐 약' },
            { text: '계획 세우고 차근차근 도전해보자', score: -1, type: '테토 약' },
            { text: '일단 해보고 안 되면 그때 생각하지 뭐', score: -2, type: '테토 강' },
        ],
    },
];
...
export const FEEDBACK_CATEGORIES = [
    { name: 'test_idea', label: '테스트 아이디어', emoji: '💡', description: '새로운 심리테스트 제안' },
    { name: 'feature', label: '기능 개선', emoji: '⚡', description: '기존 기능 개선 제안' },
    { name: 'bug_report', label: '오류 신고', emoji: '🐛', description: '발견된 버그나 문제점' },
    { name: 'design', label: '디자인', emoji: '🎨', description: 'UI/UX 개선 제안' },
    { name: 'mobile', label: '모바일', emoji: '📱', description: '모바일 환경 개선' },
    { name: 'other', label: '기타', emoji: '💭', description: '기타 의견 및 제안' },
] as const;
